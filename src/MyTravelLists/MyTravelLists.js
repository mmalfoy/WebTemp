...
function TravelCard({ name, category, duration, start, end, setSelectedTravel, setView }) {
...
function MyTravelLists({ setSelectedTravel, setView }) {
  return (
    <div className="my-travel-lists">
      {travels.map((travel, index) =>
        <TravelCard key={index} {...travel} setSelectedTravel={setSelectedTravel} setView={setView}/>)}
    </div>
  );
}
